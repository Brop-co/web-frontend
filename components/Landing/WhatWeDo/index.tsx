...
function WhatWeDo({ }) {
    ...
    return (
        <div className='w-full p-5 bg-[var(--white)] text-[#171717] h-auto flex items-center justify-evenly pl-10 pr-10'>
                    ...
                    <SwiperSlide className="swiper-slide h-auto">
                        <div className="flex flex-col items-center justify-center">
                            <Image
                                ...
                                className='w-[50%] mb-4'
                            />
                            <p className="text-center mb-11 text-[1.2em]">Mobile App Development</p>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                        <div className="flex flex-col items-center justify-between">
                            <Image
                                ...
                                className='w-[50%] mb-4'
                            />
                            <p className="text-center mb-11 text-[1.2em]">Web Development</p>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                        <div className="flex flex-col items-center justify-center">
                            <Image
                                ...
                                className='w-[50%] mb-4'
                            />
                            <p className="text-center mb-11 text-[1.2em]">Branding & Marketing</p>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                        <div className="flex flex-col items-center justify-center">
                            <Image
                                ...
                                className='w-[50%] mb-4'
                            />
                            <p className="text-center mb-11 text-[1.2em]">Iot Engineering</p>
                        </div>
                    </SwiperSlide>
                </Swiper>
            </div>
