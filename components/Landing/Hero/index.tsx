...
function Hero({}) {
  return (
    <div className='h-auto flex flex-col items-center p-5 mt-10 pb-10 gap-16  ' id='home'>
        ...
        height={100}
        alt='Brop In Tech'
        className='w-[80%] place-content-center absolute -z-10'
        />

        <div className='flex flex-col sm:flex-row justify-center gap-10 items-center pl-10 pr-10 relative top-10 text-center overflow-visible md:text-left'>
            ...
            <div className='w-[60%] absolute sm:relative -z-10 h-fit overflow-visible pt-1'>
                {/* <Image
